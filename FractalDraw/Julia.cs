...
namespace FractalDraw
{
    public partial class Julia : UserControl
    {
        ...
        public void DrawJulia(int iIterations, double Scaling, int iInitialSize, double dReal, double dIm, double iOffsetRe, double iOffsetIm, int iLeft, int iTop, int iPower, int iPower2)
        {
            picFractal.Image = DrawJuliaImage(iIterations, Scaling, iInitialSize, dReal, dIm, iOffsetRe, iOffsetIm, iLeft, iTop, iPower, iPower2, picFractal.Width, picFractal.Height);
        }

        public Bitmap DrawJuliaImage(int iIterations, double Scaling, int iInitialSize, double dReal, double dIm, double iOffsetRe, double iOffsetIm, int iLeft, int iTop, int iPower, int iPower2, int iWidth, int iHeight)
        {
            Bitmap oImage = new Bitmap(iWidth, iHeight);
            Graphics g = Graphics.FromImage(oImage);

            Generate(g, iIterations, Scaling, iInitialSize, new Complex(dReal, dIm), iOffsetRe, iOffsetIm, iLeft, iTop, iWidth, iHeight, iPower, iPower2);
            return oImage;
